...
load("results/sim_motility_PERMOT.RData")  # ret_list_full
load("results/sim_r2_motility_PERMOT.RData")  # ret_df_full_r2_adj (with adjusted r, with y sigma (sd)
...
## linear reg to get sample at power = 0.8

# define parameters
NSUB <- c(1100, 1300, 1500)
n.sims = 100


# get sample size at power = 0.8
