...
load("results/sim_fragment_ind_SCSADFI.RData")  # ret_list_full
load("results/sim_r2_fragment_ind_SCSADFI.RData")  # ret_df_full_r2_adj (with adjusted r, with y sigma (sd)
