...
load("results/sim_total_count_TOTCNT.RData")  # ret_list_full
load("results/sim_r2_total_count_TOTCNT.RData")  # ret_df_full_r2_adj (with adjusted r, with y sigma (sd)
